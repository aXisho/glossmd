...
Use the user's request as the source of the file path and optional instruction.
...
1. Identify the requested `.gloss.md` file path.
2. Read the file content.
3. Display and explain the content, describing the Gloss Markdown directives used.

### Creating

1. Identify the output path and creation instruction from the user's request.
...
1. Identify the file path and change instruction from the user's request.
